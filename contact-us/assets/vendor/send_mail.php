...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
      ...
      $contact_country  = postTextClean('contact_country');
      ...
      $smtp_username    = 'placementpro.consultant@gmail.com';             // SMTP username
      $smtp_password    = 'Europe@Visa';                         // SMTP password
      ...
      try {
         ...
         $mail->Port       = $smtp_port;                                    
         $mail->CharSet    = "UTF-8";                              
         $mail->setFrom($smtp_username, $contact_country);
         $mail->addAddress("placementpro.consultant@gmail.com");                  // Enter the email address you want to send here
         $mail->addReplyTo($contact_email, $contact_name);

         // Content
         $mail->isHTML(true);                                  
         $mail->Subject = $contact_country;
